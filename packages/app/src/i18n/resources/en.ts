export const en = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "Archive isn't available here because this workspace was not created as a Dissect worktree",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Let Dissect start and stop the built-in daemon",
        ...
        pausedStopFailed:
          "Built-in daemon management was paused, but Dissect could not stop the daemon.",
        updateFailed: "Unable to update built-in daemon management.",
      },
      keepRunning: {
        title: "Keep daemon running after quit",
        hint: "Daemon keeps running when you quit Dissect",
      },
      logs: {
        title: "Log file",
    ...
    rosetta: {
      ...
      runningIntel: "You're running the Intel build of Dissect under Rosetta on Apple Silicon.",
    ...
    permissions: {
      ...
      testNotification: {
        title: "Dissect notification test",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Unable to install the Dissect CLI.",
      },
    },
  },
  rootError: {
    title: "Dissect ran into a problem.",
  ...
  dissect: {
    empty: {
      title: "Dissect",
      subtitle: "Understand the code that is actually in this workspace.",
    },
    action: {
      dissect: "Dissect",
      dissectDiff: "Dissect Diff",
      newCode: "new code",
      agentBusy: "Wait for the agent to finish before dissecting this state.",
    },
    consent: {
      title: "Send code for analysis",
      message:
        "Dissect sends selected local workspace source files to the configured analysis model to generate explanations.",
      continue: "Continue",
    },
    config: {
      needsModel: "Dissect needs an analysis model.",
      hint: "Configure DISSECT_LLM_MODEL and the required API key, then retry.",
    },
    progress: {
      analyzing: "Analyzing codebase",
      analyzingDiff: "Analyzing changes",
      stage: {
        snapshot: "Capturing workspace snapshot",
        inventory: "Scanning local files",
        file_summaries: "Summarizing files",
        file_summaries_count: "Summarized {{completed}} of {{total}} files",
        architecture: "Building architecture…",
        diff: "Analyzing the agent-turn delta…",
        done: "Done",
      },
    },
    architecture: {
      ...
      codebase: "Codebase",
      staleNote:
        "An agent turn changed files since this dissection. It stays visible until you run Dissect Diff.",
      viewLastDiff: "View last change analysis",
      askAbout: "Ask about this codebase",
    },
    map: {
      renderFailed: "The architecture map could not be rendered.",
    },
    concepts: {
    ...
    folder: {
      ...
      files: "Files",
      noAnalyzedFiles: "No analyzed files directly in this folder.",
      askAbout: "Ask about {{path}}",
      ask: "Ask",
      markKnown: "I understand this component",
      markedKnown: "Marked as understood ✓",
    },
    diff: {
      whatChanged: "What changed",
      changedAreas: "Changed areas",
      backToArchitecture: "‹ Back to architecture",
      backToDiff: "‹ Back to Dissect Diff",
  ...
  pairing: {
    ...
    direct: {
      title: "Direct connection",
      helper: "Enter the address of a Dissect server.",
      fields: {
        host: "Host",
        port: "Port",
        password: "Password",
    ...
    remoteSsh: {
      title: "Remote SSH",
      helper: "Connect to a Dissect daemon running on the remote host.",
      fields: {
        target: "SSH host",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Read how Dissect relay works",
      ...
      updateRequired: "Update the host to enable relay from Dissect Desktop.",
      unavailable: "Pairing offer unavailable.",
      hint: "Scan this QR code with Dissect on your phone, or copy the link below.",
      securityWarning:
  ...
  panels: {
    ...
    dissect: {
      label: "Dissect",
      subtitle: "Understand this codebase",
      tooltip: "Understand the code that is actually in this workspace",
    },
    pullRequest: {
      label: "Pull request",
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "called Dissect {{count}} time",
      other: "called Dissect {{count}} times",
    },
    and: "and",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "Dissect handed the notification to the operating system.",
    ...
    metadataGeneration: {
      ...
      description:
        "Choose the model Dissect uses for workspace titles, branch names, commit messages, and pull request drafts",
      selection: "Model selection",
      automatic: "Automatic",
      preferred: "Manual",
      automaticHint: "Dissect picks a fast available model",
      preferredHint: "Choose the model Dissect uses",
      model: "Model",
      fallbackHint: "If it is unavailable, Dissect falls back to another available model",
      docs: "Docs",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "Browser tabs share sign-ins and site data across Dissect.",
    ...
    about: {
      ...
      attribution:
        "Dissect is a fork of Paseo and is licensed under Apache License 2.0. Upstream attribution is here, not in the workspace chrome.",
      ...
      updates: {
        ...
        installMessage: "This updates Dissect on this computer",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Update Dissect skills?",
        updateFallback: "Sync bundled skills to this host.",
        uninstallTitle: "Uninstall Dissect skills?",
        uninstallMessage:
          "Removes all Dissect orchestration skills from ~/.agents, ~/.claude, ~/.codex on this host.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Enable Dissect tools",
          hint: "Agents will be able to manage worktrees, agents and schedules",
          accessibilityLabel: "Inject Dissect tools",
        },
        systemPrompt: {
          title: "System prompt",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "This host is offline. Dissect reconnects automatically-wait until it's back online before restarting.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "Failed to send the restart request. Dissect reconnects automatically-try again once the host shows as online.",
          dialogFailedMessage: "Unable to open the restart confirmation dialog.",
        },
        update: {
          desktopManagedHint:
            "This daemon is managed by Dissect Desktop. Update Dissect Desktop on the host.",
          title: "Update daemon",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Dissect supervises the process and assigns a port via $PASEO_PORT",
        actions: {
          add: "Add script",
          edit: "Edit",
          remove: "Remove",
      ...
      metadata: {
        title: "Metadata generation",
        info: "Project-specific instructions injected into the AI prompts Dissect uses to generate metadata - use them to enforce your team's conventions like branch naming, commit style, or PR format",
