...
export const ptBR: TranslationResources = {
  ...
  settings: {
    ...
    about: {
      ...
      attribution:
        "Dissect é um fork do Paseo e está licenciado sob Apache License 2.0. A atribuição original fica aqui, não na interface do workspace.",
