...
set "APP_EXECUTABLE=%RESOURCES_DIR%\..\Dissect.exe"
if not exist "%APP_EXECUTABLE%" (
  echo Bundled Dissect executable not found at %APP_EXECUTABLE% 1>&2
  exit /b 1
)

set "ELECTRON_RUN_AS_NODE=1"
set "PASEO_NODE_ENV=production"
rem Marks daemons started through this bundled CLI as desktop-managed, so the
rem desktop app restarts them when it upgrades.
