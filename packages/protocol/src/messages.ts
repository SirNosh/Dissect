...
import {
  DissectStateGetRequestSchema,
  DissectCodebaseStartRequestSchema,
  DissectFolderGetRequestSchema,
  DissectFileGetRequestSchema,
  DissectDiffStartRequestSchema,
  DissectDiffGetFileRequestSchema,
  DissectChangesCheckRequestSchema,
  DissectChatAskRequestSchema,
  DissectKnowledgeSignalRequestSchema,
  DissectStateGetResponseSchema,
  DissectCodebaseStartResponseSchema,
  DissectProgressMessageSchema,
  DissectFolderGetResponseSchema,
  DissectFileGetResponseSchema,
  DissectDiffStartResponseSchema,
  DissectDiffGetFileResponseSchema,
  DissectChangesCheckResponseSchema,
  DissectChatAskResponseSchema,
  DissectKnowledgeSignalResponseSchema,
} from "./dissect.js";
  ...
  .object({
    ...
    features: z
      .object({
        ...
        // Dissect comprehension layer RPC surface.
        dissect: z.boolean().optional(),
...
// Dissect domain schemas and types are re-exported for convenience.
export * from "./dissect.js";
